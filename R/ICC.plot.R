source("~/Desktop/OHRI/work/Cohorts/! Code/IRT/R/plotCore.R", echo=TRUE)
source("~/Desktop/OHRI/work/Cohorts/! Code/IRT/R/plotICC.R", echo=TRUE)
...
ICC.plot <- function(scrfine, WfdList, dataList, Qvec, 
  ...
  # Last modified May 28 2023 by Juan Li
